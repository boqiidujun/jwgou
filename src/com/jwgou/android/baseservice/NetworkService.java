...
//		"http://211.144.76.91:180/PhoneDate.asmx/UpLoadImg"
	...
	/**
	 * 下单
	 * @param PhoneListingId 	扫货产品id
	 * @param PhoneLstingNum	订货数量
	 * @param RedEnvelopeId		红包编码
	 ...
	 * 订单列表
	 * @param UserId
	 * @param OrderState 0：代付款 2：待发货 -1：全部
	 * @param PageNums
	 * @return
	 */
