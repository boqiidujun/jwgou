...
//	}
	...
	public void setListViewHeightBasedOnChildren(Context context, ListView listView, ListAdapter listAdapter) {
		// 获取ListView对应的Adapter
		if (listAdapter == null) {
			return;
		}
...
//				MassVigUtil.dip2px(context, 10) +
	...
	public void setGridView2HeightBasedOnChildren(GridView gridView, int height) {
		...
		int totalHeight = 0;
		int len = gridView.getAdapter().getCount() / 2 + gridView.getAdapter().getCount() % 2;
